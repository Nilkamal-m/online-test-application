...
export class QuizcontentsService {
  ...
  UserPass: any[] = [
    {
      Ufname: "Nilkamal",
      Ulname: "Mahato",
      Umail: "nilkamal.35@gmail.com",
      Upass: "Nilkamal123",
    },
    {
      Ufname: "Akash",
      Ulname: "Sarkar",
      Umail: "akash123@gmail.com",
      Upass: "aks123",
    },
  ];
  ...
  tech_content: Quizformat[] = [
    ...
    },
    {
      qid: "8",
      qtext:
        "Which company became the first independent power producer to fully commission the first three wind auctions held by the SECI?",
